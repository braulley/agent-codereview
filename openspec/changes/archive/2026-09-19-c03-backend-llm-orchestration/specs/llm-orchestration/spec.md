...
Toda chamada ao provedor Gemini (`gemini-2.5-flash`) MUST ativar Structured Outputs (JSON Schema / `response_schema`) e MIME `application/json`. Chamadas sem schema imposto são proibidas.
